...
function addRtgData(elm, totalrate, nrrates, renot) {
  ...
  var htmlrtg = '<div class="totalrate"><i>Current rating:</i>'+avgrating+'</div><div class="stars"><div class="star_n" style="width:'+star_n+'px;">&nbsp;</div>'+d_rtg+'</div><em>'+nrrates+' votes</em>'
...
function rtgAjax(elm, ratev) {
  ...
  cerere_http.open("POST", 'https://'+ document.domain +'/ratingfiles/ratings.php', true); // create the request
